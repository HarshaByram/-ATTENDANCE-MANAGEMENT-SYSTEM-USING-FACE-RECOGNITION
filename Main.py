    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/tsice/OneDrive/Desktop/PROJECT/Attendance Management System using Face Recognition/Attendance/Manually Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/Users/tsice/OneDrive/Desktop/PROJECT/Attendance Management System using Face Recognition\Attendance\Manually Attendance-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/tsice/OneDrive/Desktop/PROJECT/Attendance Management System using Face Recognition/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\tsice\OneDrive\Desktop\PROJECT\Attendance Management System using Face Recognition\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'harsha':
            if password == 'harsha123':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/tsice/OneDrive/Desktop/PROJECT/Attendance Management System using Face Recognition/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
